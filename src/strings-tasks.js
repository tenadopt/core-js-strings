...
function removeFirstOccurrences(str, value) {
  ...
  return str.substring(0, startPos) + str.substring(startPos + value.length);
}
...
function removeLastOccurrences(str, value) {
  const lastPos = str.lastIndexOf(value);
  if (lastPos === -1) return str;
  return str.substring(0, lastPos) + str.substring(lastPos + value.length);
}
